...
t.test(relfreq ~ lang, data=Passives) # this puts AmE first!

# side-by-side boxplots can be created with the "lattice" package
library(lattice)
...
# can't compute prediction intervals for new texts -- why?
