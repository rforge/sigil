...
## Case study: frequency comparison for number of passives in Brown (AmE)
...
## alternatively, data sets are also included in the SIGIL package
library(SIGIL)
Brown <- BrownPassives
LOB <- LOBPassives
...
ct
fisher.test(ct) # effect size = odds ratio
