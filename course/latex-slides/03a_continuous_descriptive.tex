...
\begin{frame}[fragile]
  ...
  \item How would you describe body heights with a single number?%
    ...
    \]
  \item Is this intuitiveley sensible? Or are we just used to it?
  \end{itemize}
...
\begin{frame}
  ...
  \addnote{Optional task: look at example data and compute histograms.  Which
    distribution types do you find?}%
\end{frame}
