...
\begin{frame}
  ...
  \item<2-> Similarity measures
    ...
    \item multivariate \primary<3->{chi-squared statistic $X^2$} takes sampling variaton (and covariance of spectrum elements) into account
    \end{itemize}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \only<beamer:2| handout:0>{\includegraphics[width=10cm]{img/05-bootstrap-ultra-A}}%
    \only<beamer:3| handout:0>{\includegraphics[width=10cm]{img/05-bootstrap-ultra-B}}%
...
\REM{combine results into single data frame}
